    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
          ...
          <form onSubmit={handleTransfer} className="p-6 space-y-6">
            ...
            <div className="space-y-4">
              <div>
                <label htmlFor="recipientAccountNum" className="block text-sm font-medium text-gray-700 mb-1">
        ...
        <div className="mt-6 text-center text-sm text-gray-500">
          <p>Need help? Contact our <a href="#" className="text-blue-600 hover:text-blue-800">support team</a></p>
        </div>
      </div>
    </div>
  );
